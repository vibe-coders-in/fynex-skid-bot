    ...
    run: async (client, message, args) => {
        try {
            const embed = new MessageEmbed()
                .setColor('#00FFFF')
                .setFooter(`Developed By Flixo Team`);
            ...
            let link = 'https://discord.gg/qEgZHGWaUY';

            if (!args[0]) {
                embed.setAuthor(
                    `${client.user.username} Premium`,
                    client.user.displayAvatarURL(),
                    'https://discord.gg/qEgZHGWaUY'
                );
            ...
            console.error('An error occurred in the premium command:', error);
