                ...
                try {
                        ...
                        if (message.member.manageable) {
                            try {
                                await message.member.timeout(
                                    30 * 60 * 1000,
                                    'Flixo-Advance | ANTILINK | TIMEOUT'
                                )
                    ...
                    if (action === 'ban') {
                        ...
                        if (message.member.bannable) {
                            try {
                                let reason = 'Flixo-Advance | ANTILINK | BAN'
                        ...
                        if (!action || action === 'mute') {
                            ...
                            if (message.member.manageable) {
                                try {
                                    await message.member.timeout(
                                        30 * 60 * 1000,
                                        'Flixo-Advance | ANTISPAM | TIMEOUT'
                                    )
