...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = 'https://discord.gg/qEgZHGWaUY'
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(`#0x2b2d31`)
                                .setDescription(
                                    `Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/qEgZHGWaUY) was removed.\nClick [hhttps://discord.gg/qEgZHGWaUYrfzop) To Buy https://discord.gg/qEgZHGWaUYd.gg/rfzop).`
                                )
                        ],
                        components: [premrow]
                    })
                            ...
                            .send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(`#0x2b2d31`)
                                        .setDescription(
                                            `Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.gg/qEgZHGWaUY) was removed.\nClick [hhttps://discord.gg/qEgZHGWaUYrfzop) To Buy https://discord.gg/qEgZHGWaUYd.gg/rfzop).`
                                        )
                                ],
                                components: [premrow]
                            })
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(`#0x2b2d31`)
                                .setDescription(
                                    `The Premium Of This Server Has Got Expired.\nClick [here](https://discord.gg/qEgZHGWaUY) To Buy [Premhttps://discord.gg/qEgZHGWaUYrfzop).`
                                )
                        ],
                        components: [premrow]
                    })
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setDescription(
                                `\n**Hey! I am Flixo \n**Hey** ${message.author},\n **My Prefix here is:*.* \`${message.guild.prefix}\`\n**[Invite Me](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) | [Support Server](https://discord.gg/qEgZHGWaUY)**\n\n**Type** \`${message.guild.prefix}\help\` **To Get The Command List.**`
                            )
                            .setFooter({
                                text: `Developed by Team Flixo`,
            ...
            if (
                ...
                const row = new MessageActionRow().addComponents(
                    ...
                    new MessageButton()
                        .setLabel('Premium')
                        .setStyle('LINK')
                        .setURL('https://discord.gg/qEgZHGWaUY')
                )
                    ...
                    if (now < expirationTime) {
                        ...
                        if (commandCount > commandLimit) {
                            ...
                            const ricky = new MessageEmbed()
                                ...
                                .addField(
                                    'Support Server',
                                    '[Join our support server](https://discord.gg/qEgZHGWaUY )',
                                    true
                                )
                                .setTimestamp()
